...
Usage:
    ...
    # Non-streaming dumped windows (no convert_to_streaming_window):
    python eval/eval_system_opt.py --dumped-data-dir /path/to/dumped_eval_data --clip-ids-file ./clips.json
"""
