...
# Lazy import: gemv_op / gemm_op register torch.ops.awq.* and require
# the old AWQ CUDA kernels.  Only import when WQLinear.forward() is called.
_awq_ops_loaded = False
