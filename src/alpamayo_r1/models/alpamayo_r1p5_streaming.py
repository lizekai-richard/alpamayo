...
class StreamingAlpamayo1_5(ReasoningVLA):
    """Streaming Expert model for reasoning VLA (Alpamayo 1.5) with torch.compile support."""
    ...
    def __init__(
        ...
        self.max_cache_len = self.prefill_seq_length + 256 + 64
        self.num_views = 4
...
AutoModel.register(Alpamayo1_5Config, StreamingAlpamayo1_5)
