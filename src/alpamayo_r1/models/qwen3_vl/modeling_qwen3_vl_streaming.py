...
class Qwen3VLModel(Qwen3VLPreTrainedModel):
    ...
    def embed_tokens(self, input_ids, pixel_values, pixel_values_videos, image_grid_thw, video_grid_thw, **kwargs: Any) -> torch.Tensor:
        """
...
class Qwen3VLForConditionalGeneration(Qwen3VLPreTrainedModel, GenerationMixin):
    ...
    def embed_tokens(self, *args: Any, **kwargs: Any) -> torch.Tensor:
        return self.model.embed_tokens(*args, **kwargs)
